...
func setup(ctx_player: Player, ctx_ball: Ball, ctx_animation_player: AnimationPlayer, ctx_teammate_detection_area: Area2D, ctx_state_data: PlayerStateData) -> void:
	player = ctx_player
	ball = ctx_ball
